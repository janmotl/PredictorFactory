...
public class Aggregation {
	...
	@NotNull public static Journal run(@NotNull Setting setting, @NotNull SortedMap<String, OutputTable> tableMetadata) {
	...
	@NotNull private static Journal fromScratch(@NotNull Setting setting, @NotNull SortedMap<String, OutputTable> tableMetadata) {
	...
	protected static List<Predictor> loopPatterns(@NotNull Setting setting) {
	...
	private static List<Predictor> filterRequiresBaseDate(@NotNull Setting setting, @NotNull List<Predictor> predictorList) {
	...
	@NotNull protected static List<Predictor> addTargetValue(@NotNull Setting setting, @NotNull Predictor predictor, @NotNull Set<String> uniqueValueSet) {
	...
	@NotNull protected static List<Predictor> loopParameters(@NotNull Predictor predictor) {
	...
	@NotNull private static List<Predictor> expandParameter(@NotNull List<Predictor> predictorList, String parameterName, @NotNull String[] parameterValueList) {
	...
	@NotNull protected static List<Predictor> loopTables(@NotNull Predictor predictor, @NotNull SortedMap<String, OutputTable> tableMetadata) {
	...
	@NotNull protected static List<Predictor> loopColumns(@NotNull Setting setting, @NotNull Predictor predictor) {
	...
	@NotNull private static List<Predictor> expandColumn(@NotNull Setting setting, @NotNull List<Predictor> predictorList, @NotNull String columnKey, @NotNull OutputTable table) {
	...
	@NotNull protected static List<Predictor> addValue(@NotNull Predictor predictor) {
	...
	@NotNull private static List<Predictor> optimizeAll(@NotNull Predictor predictor, int groupId) {
		// Initialization
		List<Predictor> outputList = new ArrayList<>();
	...
	@NotNull private static List<Predictor> optimize(@NotNull List<Predictor> predictorList, @NotNull OptimizeParameters parameter) {
		// Initialization
		List<Predictor> outputList = new ArrayList<>();
	...
	@NotNull private static Predictor preparePredictor(@NotNull Setting setting, @NotNull Journal journal, @NotNull Predictor predictor) {
	...
	@NotNull private static Journal materializePredictors(@NotNull Setting setting, @NotNull Journal journal, @NotNull List<Predictor> predictorList) {
	...
	private static void materializePredictor(@NotNull Setting setting, @NotNull Predictor predictor, int maxRowLimit) {
	...
	@NotNull protected static Predictor addSQL(@NotNull Predictor predictor, String sql) {
	...
	private static void getPredictorType(@NotNull Setting setting, @NotNull Predictor predictor) {
