...
public class MetaInput {
	...
	public static SortedMap<String, Table> getMetaInput(Setting setting) {
		...
		List<String> whiteListTable = TextParser.string2list(setting.whiteListTable); // Parsed values
		List<String> blackListTable = TextParser.string2list(setting.blackListTable); // Parsed values
		Map<String, List<String>> whiteMapColumn = TextParser.list2map(TextParser.string2list(setting.whiteListColumn)); // Parsed values
		Map<String, List<String>> blackMapColumn = TextParser.list2map(TextParser.string2list(setting.blackListColumn)); // Parsed values
		...
		// Get tables
		tableMap = Meta.collectTables(setting, database, schema);
