...
public class MetaInput {
	...
	public static SortedMap<String, Table> getMetaInput(Setting setting) {
		...
		for (String tableName : tableMap.keySet()) {
			...
			tableData.foreignConstraintList = ForeignConstraint.combine(ForeignConstraint.jdbcToList(Meta.downloadRelationships(setting, database, schema, tableName), tableName));
