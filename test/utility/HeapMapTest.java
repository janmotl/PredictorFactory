...
public class HeapMapTest {
	...
	public void modification() {
		...
		String mutagenic = setting.baseTargetList.get(0);
		String ind1 = setting.baseTargetList.get(1);
		HeapMap heapMap = new HeapMap(setting.baseTargetList, Predictor.SingleRelevanceComparator, 2);
	...
	public void serialization() throws JAXBException {
		Setting setting = new Setting("MariaDB", "mutagenesis_multiple");
		HeapMap original = new HeapMap(setting.baseTargetList, Predictor.SingleRelevanceComparator, 2);
