...
public class MetaTest {
	...
	public void testCollectSchemas_Azure() {
		...
		Assert.assertTrue(schemaList.contains(setting.targetSchema));
	...
	public void testCollectRelations_Azure() {
		...
		Network.openConnection(setting);
		List<ForeignConstraint> relationList = Meta.collectRelationships(setting, setting.targetSchema, "loan");
		Network.closeConnection(setting);
