...
public class TextAreaAppender extends WriterAppender {
	...
	private static final String text = "...The log window is limited to the last " + messageCountLimit + " messages. The whole log is in the 'log' directory.\n";
	private final List<Integer> messageLengthList = new LinkedList<>(); // Lengths of messages within the text area


	/**
	 * Set the target TextArea for the logging information to appear.
	 *
	 * @param textArea for displaying the logging events
	 */
	 ...
	 *
	 * @param loggingEvent to display in the textArea
	 */
	@Override
